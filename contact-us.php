        ...
        <div class="auto-container">
            <div class="row">
                        ...
                        <div class="contact-form">
                            <form method="post" action="https://api.web3forms.com/submit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <button class="theme-btn btn-style-three" type="submit" name="btn_enq">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="contact-info">
                            <div class="row">
                                <div class="info-block col-lg-4 col-md-4 col-sm-12">
                                    <div class="inner">
                                        <h4>Location</h4>
                                        <p>Sunder Apartment, Block GH10, 56A, Paschim Vihar, Delhi, 110087</p>                                    </div>
                                </div>

                                <div class="info-block col-lg-4 col-md-4 col-sm-12">
                                    <div class="inner">
                                        <h4>Call Us</h4>
                                        <p><a href="tel:+91-9136165775">+91-9136165775</a></p>                                    </div>
                                ...
                                <div class="info-block col-lg-4 col-md-4 col-sm-12">
                                    <div class="inner">
                                        <h4>Email</h4>
                                        <p><a href="mailto:rajanmaluujaarts@gmail.com">rajanmaluujaarts@gmail.com</a></p>                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="map-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                         <div class="map-outer">
                           <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14003.379742160028!2d77.0912992!3d28.6643613!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04745d1d9223%3A0x72369abf0482de50!2sRAJAN%20MALUUJA%20ARTS!5e0!3m2!1sen!2sin!4v1678354819879!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
