    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button class="btn btn-sm btn-info" data-bs-toggle="modal"
              data-bs-target="#viewModal<?= $inq['id'] ?>">View</button>
            <a href="delete_inquiry.php?id=<?= $inq['id'] ?>" class="btn btn-sm btn-danger"
        ...
        <div class="modal fade" id="viewModal<?= $inq['id'] ?>" tabindex="-1"
          aria-labelledby="viewModalLabel<?= $inq['id'] ?>" aria-hidden="true">
