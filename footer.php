                            ...
                            <div class="footer-widget about-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="add-address-footer-txt">
                                        <li><i class='fa fa-map-marker' aria-hidden='true'></i> Sunder Apartment, Block
                                            GH10, 56A, Paschim Vihar, Delhi, 110087</li>
                                        <li><a href='tel:+91-9136165775' class='text-white'><i class='fa fa-mobile'
                                                    aria-hidden='true'></i> +91-9136165775</a></li>
                                        <li><a href='mailto:rajanmaluujaarts@gmail.com' class='text-white'><i
                                                    class='fa fa-envelope-o' aria-hidden='true'></i>
                                                rajanmaluujaarts@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="widget-content footerfrm">
                                    <form method="post" action="https://api.web3forms.com/submit">
                                        <input type="hidden" name="access_key"
                                            value="8c5317b0-7959-4807-a15d-68b0d4fc6f7b">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" name="btn_enq"
                                                class="theme-btn btn-style-three">Submit now</button>
                                        </div>
                                    </form>
                                    <div>
                                    </div>
            ...
            <div class="inner-container clearfix">
                <div class="social-links">
                    <ul class="social-icon-two">
                        <li><a href="https://www.facebook.com/RajanMaalujaArts" target="_blank"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/RajanMaaluja" target="_blank"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li><a href="https://www.instagram.com/rajanmaluujaarts/" target="_blank"><i
                                    class="fa fa-instagram"></i></a></li>
                        <li><a href="https://in.pinterest.com/rajanmaluujaarts/" target="_blank"><i
                                    class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
                        <li><a href="https://www.linkedin.com/in/rajanmaluujaarts/" target="_blank"><i
                                    class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                        <li><a href="https://www.youtube.com/channel/UCd2Hd7CovuFWv43706dcs6A" target="_blank"><i
                ...
                <div class="copyright-text">
                    <p>Copyright © 2023 <a href="#">Rajan Maaluja Arts</a> All right reserved
                        <!--| Designed & Developed by : <a href="http://viraladsmedia.com/" target="_blank">Viral Ads Media</a></p> -->
                </div>
            </div>
        </div>
    </div>
...
<div class="whatsapp-btn">
    <a href="https://api.whatsapp.com/send?phone=919136165775&amp;text=" class="whatsappWidget phone-btn"
        target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i> <span>What's App</span></a></div>
</body>
