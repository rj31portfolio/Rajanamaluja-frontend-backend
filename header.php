    ...
    <div class="auto-container">
        <div class="header-lower">
            <div class="main-box clearfix">
                <div class="logo-box">
                    <div class="logo">
                        <a href="<?php echo BASE_URL; ?>"><img src="images/rajan-maluuja-logo.png" alt="Portrait Painting Artist in Delhi" title="Portrait Painting Artist in Delhi"></a>
                    </div>
                </div>
                    ...
                    <nav class="main-menu navbar-expand-md">
                        <div class="navbar-header">
                            <button class="mobile_cart_button" type="button">
                                <a href="<?php echo BASE_URL; ?>cart.php" class="text-white"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                        ...
                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="<?php echo BASE_URL; ?>oil-painting-art.php">Oil Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>portrait-painting-art.php">Portrait Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>acrylic-painting.php">Acrylic Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>tanjore-painting-art.php">Tanjore Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>divine-painting-art.php">Divine Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>painting-on-objects.php">Painting On Objects</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>canvas-painting-art.php">Canvas Painting Art</a></li>
                                        <li><a href="<?php echo BASE_URL; ?>sketch-art-work.php">Sketch Art Work</a></li>
