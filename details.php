...
<div class="page-wrapper">
    ...
    <section class="page-title"
        style="background-image:url(https://png.pngtree.com/thumb_back/fh260/background/20220215/pngtree-grey-minimalist-oil-paint-splashes-on-the-banner-background-image_926107.jpg);">
                        ...
                        <div class="inner-box">
                            ...
                            <div class="art-specification text-dark">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Year Created:</strong> <?php echo htmlspecialchars($art['year']); ?>
                                    </li>
                                    <?php endif; ?>
                            ...
                            <div class="social-sharing">
                                ...
                                <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode("Check out this artwork: " . $art['title']); ?>&url=<?php echo urlencode("https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>"
                                    target="_blank" class="twitter"><i class="fa fa-twitter"></i></a>
                                <a href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode("https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>&media=<?php echo urlencode("https://$_SERVER[HTTP_HOST]" . $mainImage); ?>&description=<?php echo urlencode($art['title']); ?>"
                                    target="_blank" class="pinterest"><i class="fa fa-pinterest"></i></a>
                                <a href="whatsapp://send?text=<?php echo urlencode("Check out this artwork: " . $art['title'] . " - https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>"
            ...
            ?>
                                <div class="art-block col-lg-4 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <a
                                                href="details.php?slug=<?php echo htmlspecialchars($related['slug']); ?>">
                               ...
                               // session_start(); // Start the session to access the success message
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" placeholder="Enter Your Name"
                                        class="form-control input" title="Accept Only Name and Space"
                                ...
                                <input class="btn btn-default add-bg-footer-form" name="btn_enq" type="submit"
                                    value="Submit">
                            </form>
                        </div>
